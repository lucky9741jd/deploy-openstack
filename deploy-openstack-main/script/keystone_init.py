...
[auth]
[cache]
memcache_servers = 222.20.78.180:11211
[catalog]
[cors]
[credential]
[database]
connection = sqlite:////var/lib/keystone/keystone.db
connection = mysql+pymysql://keystone:lucky@222.20.78.180/keystone
[domain_config]
[endpoint_filter]
[endpoint_policy]
[eventlet_server]
...
[wsgi]"""
    ...
    runcmd('sed -i "s/222.20.78.180/%s/g" /etc/keystone/keystone.conf' % mgmt_ip) 
    runcmd('sed -i "s/lucky/%s/g" /etc/keystone/keystone.conf' % root_password)    
